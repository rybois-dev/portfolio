...
public class VuePlateau extends Pane {
    ...
    private void ajouteRailATuile(Tuile t, Joueur j, Circle c) {
        ...
        String couleur = CouleursJoueurs.couleursBackgroundJoueur.get(j.getCouleur());
        c.setFill(Color.web(couleur));
    }
    ...
    private void choixTuile(MouseEvent event) {
        ...
        System.out.println("La Tuile " + tuile.getId() + " à été choisie !");
    }}
